...
def history(input_numbers):
    ...
    json_file = open('C:\\Users\\PAVAN BHAVARAJU\\Desktop\\Price Forecasting Project\\modelhs.json', 'r')
    ...
    with graph.as_default():
        ...
        loaded_model.load_weights("C:\\Users\\PAVAN BHAVARAJU\\Desktop\\Price Forecasting Project\\modelhs.h5")
